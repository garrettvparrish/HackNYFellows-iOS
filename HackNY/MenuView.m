...
- (void)viewDidLoad {
    [super viewDidLoad];
        ...
        iCarouselExampleViewController *carousel = [[iCarouselExampleViewController alloc] init];
        carousel.view.frame = CGRectMake(0, 0, 320, self.view.bounds.size.height);
        [self.view addSubview:carousel.view];
        [self addChildViewController:carousel];
        [carousel didMoveToParentViewController:self];
